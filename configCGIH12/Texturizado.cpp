...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		1. Mostrar el cuadrante 1 (inferior derecha)
		2. Mostrar el cuadrante 2 (superior izquierda)
		3. Mostrar el cuadrante de en medio.
		
		1. 2 y media ventanas x 5 ventanas
		2. 4 ventanas y 10 ventanas
		*/
	}
