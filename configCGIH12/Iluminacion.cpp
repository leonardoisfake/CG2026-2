...
glm::vec3 lightPos2(0.5f, 0.5f, -3.0f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 1.0f, 1.0f, 0.0f);
        ...
        /*Ejercicio: colocar una segunda fuente de luz con movimiento, que afecte al modelo.*/
